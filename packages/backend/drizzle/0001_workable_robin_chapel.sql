...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "compliance_report_repository_id_idx" ON "compliance_reports" USING btree ("repository_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "compliance_report_generated_at_idx" ON "compliance_reports" USING btree ("generated_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "manufacturer_name_idx" ON "manufacturers" USING btree ("name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "product_repo_product_idx" ON "product_repositories" USING btree ("product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "product_repo_repo_idx" ON "product_repositories" USING btree ("repository_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "product_repo_unique" ON "product_repositories" USING btree ("product_id","repository_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "product_name_idx" ON "products" USING btree ("name");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "product_gtin_idx" ON "products" USING btree ("gtin");--> statement-breakpoint
